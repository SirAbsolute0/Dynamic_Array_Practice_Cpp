...
int main()
{
	...
	monthSales = new float[numOfSales];							// Fill in the code to allocate memory for the array pointed to by
																// monthSales.
	*monthSales = 1;
	if (*monthSales != 1)										// Fill in the condition to determine if memory has been													// allocated (or eliminate this if construct if your instructor											// tells you it is not needed for your compiler) )
	{
